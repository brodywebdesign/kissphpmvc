...
<td>See <a href="#custom-tooltips">custom tooltip</a> section.</td>
</tr>
<tr>
...
<p>Allows sorting of <a href="#chart-configuration-tooltip-item-interface">tooltip items</a>. Must implement at minimum a function that can be passed to <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/sort" target="_blank">Array.prototype.sort</a>.  This function can also accept a third parameter that is the data object passed to the chart.</p>
<h3 id="filter-callback">Filter Callback</h3>
<p>Allows filtering of <a href="#chart-configuration-tooltip-item-interface">tooltip items</a>. Must implement at minimum a function that can be passed to <a href="https://developer.mozilla.org/en/docs/Web/JavaScript/Reference/Global_Objects/Array/filter" target="_blank">Array.prototype.filter</a>. This function can also accept a second parameter that is the data object passed to the chart.</p>
