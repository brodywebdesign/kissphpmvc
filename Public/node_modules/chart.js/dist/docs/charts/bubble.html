...
<p>All properties, except <code>label</code> can be specified as an array. If these are set to an array value, the first value applies to the first bubble in the dataset, the second value to the second bubble, and so on.</p>
<table>
<thead>
<tr>
<th>Name</th>
...
<td>The fill color for bubbles.</td>
</tr>
<tr>
<td><code>borderColor</code></td>
<td><code>Color/Color[]</code></td>
<td>The border color for bubbles.</td>
</tr>
<tr>
<td><code>borderWidth</code></td>
<td><code>Number/Number[]</code></td>
<td>The width of the point bubbles in pixels.</td>
</tr>
<tr>
...
<td><code>Color/Color[]</code></td>
<td>Bubble border color when hovered.</td>
</tr>
<tr>
...
<p>The bubble chart has no unique configuration options. To configure options common to all of the bubbles, the <a href="../configuration/elements/point.md#point-configuration">point element options</a> are used.</p>
...
<p>For a bubble chart, datasets need to contain an array of data points. Each point must implement the <a href="#bubble-data-object">bubble data object</a> interface.</p>
<h3 id="bubble-data-object">Bubble Data Object</h3>
<p>Data for the bubble chart is passed in the form of an object. The object must implement the following interface. It is important to note that the radius property, <code>r</code> is <strong>not</strong> scaled by the chart. It is the raw radius in pixels of the bubble that is drawn on the canvas.</p>
