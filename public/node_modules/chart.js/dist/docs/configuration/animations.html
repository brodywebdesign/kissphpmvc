...
<p>Another example usage of these callbacks can be found on <a href="https://github.com/chartjs/Chart.js/blob/master/samples/animation/progress-bar.html" target="_blank">Github</a>: this sample displays a progress bar showing how far along the animation is.</p>
